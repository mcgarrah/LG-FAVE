...
CONSONANTS = ['B', 'D', 'DH', 'DJ', 'DQ', 'F', 'G', 'HH', 'J', 'K', 'L', 'M', 'N', 'NG', 'P', 'R', 'RR', 'RX', 'S', 'SJ', 'T', 'TH', 'TJ', 'V', 'W', 'X', 'Z', 'ZH']
VOWELS = ['AA', 'AE', 'AEE', 'AEEH', 'AEH', 'AJ', 'AW', 'EE', 'EH', 'ER', 'IH', 'II', 'OA', 'OAH', 'OE', 'OEE', 'OEEH', 'OEH', 'OH', 'OJ', 'OO', 'OOR', 'OR', 'OUH', 'Q', 'UH', 'UU', 'YH', 'YY']
